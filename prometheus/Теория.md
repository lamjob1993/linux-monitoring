...
1. **4 золотых сигнала (Four Golden Signals)**:
...
3. **Временной ряд (Time Series)** в Prometheus — это последовательность данных, которая описывает изменение метрики во времени. Каждый временной ряд состоит из:
...
6. **Сервис-дискавери (Service Discovery)**  
