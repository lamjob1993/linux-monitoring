...
12. Далее создать 2 директории и 2 файла внутри домашней директории **/Documents/linux-monitoring/prometheus** (подсказка: **mkdir consoles, console_libraries** - создаст 2 директории сразу):
    - **/consoles**
    - **/console_libraries**
    - **unit_file** и написать его (Подсказка: логически понять, как правильно назвать **Unit** файл (это будет файл сервиса **Prometheus**)
    - **prometheus.yml** и написать его (Подсказка: **GitHub** - **prometheus/documentation/examples/prometheus.yml**)  
13. Скопировать в директорию **/bin** бинарь **Prometheus** (подсказка: **п.4**).
14. В директории **/etc** создать пустой файл - **prometheus.yml**:
