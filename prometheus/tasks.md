...
#### 2. **Чтение конфигурационного файла**
   ...
   - Конфигурационный файл содержит:
     - **Цели скрапинга**: список экспортеров и сервисов, метрики которых будут собираться.
...
#### 6. **Взаимодействие с веб-интерфейсом**
   ...
   - Веб-интерфейс позволяет:
     ...
     - Просматривать текущие цели скрапинга и их статус.
...
2. Чтение конфигурационного файла для настройки целей скрапинга и правил.
