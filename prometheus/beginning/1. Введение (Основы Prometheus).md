...
sequenceDiagram
    ...
    Exporter->>App: Сбор метрик через внутренние механизмы (API, файлы, библиотеки)
    App-->>Exporter: Ответ через методы доступа (например, возврат данных из API, файлов или библиотек) [[6]]
