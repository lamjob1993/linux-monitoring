...
_Сначала думаем над каждым заданием в разделе `Backend`, если не можем понять какой-то инструмент не менее 40-ка минут и только потом смотрим этот раздел по пунктам!_
