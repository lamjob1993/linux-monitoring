...
- Данный процесс запуска любят спрашивать на собеседованиях в части `Linux`, поэтому мы его рассматриваем на примере мониторинга в разрезе `Prometheus`, что является очень показательным, наглядным и полезным, на данном этапе у вас формируется более глубокое представление о запуске сервиса мониторинга, а также постепенно вплетаются те знания в части `Linux`, о которых вы читали в сатьях у меня на курсе.
