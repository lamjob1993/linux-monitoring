...
**Custom Exporter** — это пользовательский (кастомный) инструмент или скрипт, который собирает определенные данные и предоставляет их в формате, подходящем для мониторинга с помощью систем, таких как **Prometheus**. 
