...
0. **Теория и фундаментальные основы**
    * [Изучить необходимую теорию](https://teletype.in/@lamjob/wjNvt64l77l) перед прохождением курса на GitHub ([мини-практику по Linux выполняем обязательно](https://teletype.in/@lamjob/SsV-puwmQlR))
1.  **Введение в мониторинг и общие концепции**
    ...
    * [Вопросы по стеку сопровождения и мониторинга](https://teletype.in/@lamjob/sPRL_XpiLkV)
       * **Учим строго сразу**: Linux → Сети → Docker
