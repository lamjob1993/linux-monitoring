...
### Последовательность выполнения заданий (навигация курса)
  ...
  17. Открываем директорию **`interview_questions`** → `1` → `2` → `3`
  ...
  21. Продолжаем изучение мониторинга в [следующем разделе](https://github.com/lamjob1993/ansible-monitoring) по **`Ansible`**
  22. Продолжаем изучение мониторинга в [следующем разделе]() по **`CI/CD: Teamcity`**
  23. Продолжаем изучение мониторинга в [следующем разделе](https://github.com/lamjob1993/kubernetes-monitoring/tree/main) по **`Kubernetes`**
