...
0. **Теория и фундаментальные основы**
    * [Изучить необходимую теорию](https://teletype.in/@lamjob/wjNvt64l77l) перед прохождением курса на GitHub ([мини-практику Linux выполняем обязательно](https://teletype.in/@lamjob/SsV-puwmQlR))
