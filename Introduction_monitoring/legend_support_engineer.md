...
- Если есть какие-либо аномалии или инциденты, я сразу же начинаю их расследование.
   - Вброс от собеседующего. Например, расскажи какая была самая простая задача и какая самая сложная?
      - **Простая**. Установка Node Exporter, ставил сам на нужные сервера.
      ...
      - **Сложная**. Балансировка нагрузки на Nginx совместно с администраторами.
         - Как балансировал? Какие директивы знаешь? Что такое round-robin?
            - Я написал YAML файл для балансировки по
            - Это алгоритм балансировки нагрузки и диктуем собеседующему построчно:
            ```yaml
            ...
            ```
            - Расшифровка конфига Nginx YAML:            
...
Эта конфигурация создает простой балансировщик нагрузки, который равномерно распределяет запросы между тремя бэкенд-серверами.
...
- Мониторинг состояния систем через Prometheus и Grafana
   - Смотрю на действующие дашборды.
   - Обращаю внимание на анамалии, если есть: просадка трафика, перезапуск подов, проверка бизнесовых ошибок, проверка сервисов, написанных на Java/Kotlin)).
- Решение инцидентов, которые могут возникнуть в процессе работы
   - Собираем или свою встречу или идем в аварийку и решаем совместно инцидент
      - Кто собирал? Я собирал, я делал рассылку, я пинговал в ТГ, в корпоративном мессенджере.
