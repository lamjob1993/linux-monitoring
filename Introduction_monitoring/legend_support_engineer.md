...
1. В первом приближении в самом начале репозитория `linux-monitoring` с данным разделом знакомимся поверхностно, чтобы понять объемы и масштабы, но при этом сразу учим легенду, чтобы она хорошо отложилась для будущих собеседований
2. Во втором приближении после завершения данного репозитория `linux-monitoring` начинаем учить все вопросы из данного раздела
   - Общие вопросы, разбиение собеседования на последовательные этапы и вопросы работодателя, [учим здесь](https://teletype.in/@lamjob/sPRL_XpiLkV) после прочтения данного раздела
   - Далее учим [дополнительный пул вопросов](https://teletype.in/@lamjob/dzsUuHD-XGj), после прочтения данного раздела
