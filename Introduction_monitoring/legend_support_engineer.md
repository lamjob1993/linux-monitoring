...
Здесь идёт перечисление инструментов и ПО [из раздела номер 3 по вашему стеку - перечисляем обязательно, чтобы собеседующие поняли, что вы с этими инструментами работаете повседневно](https://github.com/lamjob1993/linux-monitoring/blob/main/Introduction_monitoring/legend_support_engineer.md#3-%D1%81%D1%82%D0%B5%D0%BA-%D0%BE%D1%82%D0%B4%D0%B5%D0%BB%D0%B0).
...
- x3 инженера junior по сопровождению
