...
_То есть мы учим легенду и как будто бы присутствуем на одном из ваших собесов. А также я понимаю, что это может быть лишь один из вариантов собеседования, ведь все собеседования разные, но зато это уникальный и очень удобный формат)._
