...
- Для установки берем чистый образ [Debian Netinst 12.9.0 (amd64)](https://www.debian.org/CD/netinst/ "CD для сетевой установки, или netinst — это один компакт-диск, позволяющий установить всю операционную систему. Он содержит только самое необходимое программное обеспечение для того, позволяющее установить базовую систему и загрузить все остальные пакеты по сети.") и ставим без Desktop Environment (DE)
