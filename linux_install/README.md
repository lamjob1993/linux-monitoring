...
- Сделайте ping трех машин друг до друга (слева на скриншоте указано два клона), сделайте пинг этих клонов с хостовой системы Windows (справа на скриншоте пинг двух клонов)
