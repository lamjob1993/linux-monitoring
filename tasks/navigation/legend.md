# Легенда инженера по сопровождению ПО, работающего в отделе мониторинга к собеседованию
(в резюме ничего отсюда не берем)
...
Здесь идёт перечисление инструментов и ПО [из раздела номер 3 по вашему стеку](https://github.com/lamjob1993/linux-monitoring/blob/main/interview_questions/1.%20%D0%9B%D0%B5%D0%B3%D0%B5%D0%BD%D0%B4%D0%B0%20%D0%B8%D0%BD%D0%B6%D0%B5%D0%BD%D0%B5%D1%80%D0%B0%20%D1%81%D0%BE%D0%BF%D1%80%D0%BE%D0%B2%D0%BE%D0%B6%D0%B4%D0%B5%D0%BD%D0%B8%D1%8F.md#3-%D1%81%D1%82%D0%B5%D0%BA-%D0%BE%D1%82%D0%B4%D0%B5%D0%BB%D0%B0) - перечисляем обязательно, чтобы собеседующие поняли, что вы с этими инструментами работаете повседневно.
...
### 4. **Беглые вопросы к инструментам, которых нет в этом репозитории, но есть в следующих (выписаны они, если вы попадете на собеседование раньше положенного срока)**
...
3. Как вы организовывали уведомления о статусе билдов?
   - Ответ: Настроил интеграцию с Telegram для отправки уведомлений о завершении билдов.
