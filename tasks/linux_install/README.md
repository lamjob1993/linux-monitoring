...
### Почему мы выбрали **Debian**
  ...
  - Системные требования очень низкие, после запуска нагрузка на RAM не превышает = `270Мб` (без GUI)
...
- Установите гостевые дополнения
  - Смонтируйте диск в VirtualBox через контекстное меню
  - Далее зайдите на cdrom и введите
  ```bash
  sudo sh ./VBoxLinuxAdditions.run
  ```
  - Установка пакета автодополнения
  ```bash
