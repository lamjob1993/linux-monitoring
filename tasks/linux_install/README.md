...
- Для **VMWare Workstation Pro** выбираем следующие параметры:
  - **RAM**: `2048Mb`
  - **HDD**: `30Gb` / можно не бояться за объем, он будет расти по мере потребления, после установки занято будет где-то 10ГБ, но расширять в дальнейшем сильно сложнее, проще взять универсально 30
  - **CPU**: `4 Cores`
  - **Network**: `NAT`
