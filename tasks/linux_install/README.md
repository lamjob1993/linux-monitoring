...
**! UPD.** Теперь берем для курса машины [Xubuntu 24.04.4](https://cdimage.ubuntu.com/xubuntu/releases/noble/release/)
- То есть вместо Debian ниже - ставим Desktop версию Xubuntu 24.04.4 AMD64
- Это связано с тем, что в Debian не достает достаточного количества настроек, пакетов, пользователей и т.д, иными словами говоря на примере студентов я понял, что это головная боль, а когда вы будете работать на ПРОДе в рабочей среде, то каждая машина будет настроена (сопровождение/мониторинг), если попадаете глубже в DevOps, то там уже будет видно по месту что и как
...
### Установка Debian. Часть 1 / Ставим Xubuntu / 2Gb, 25Gb, 2 Cores
...
### Клонирование Debian. Часть 2 / Клонируем Xubuntu
