...
---
- По заданиям мы скачаем и вручную распакуем архивы с бинарями: `системы мониторинга Prometheus`, `Grafana`, `Node Exporter` и прочих экспортеров
- Напишем их автозапуск с помощью `Unit-файлов`
