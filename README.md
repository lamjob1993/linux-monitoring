...
2. Взять директорию из корня - **/opt** и создать в ней рабочую директорию - **/monitoring** и склонировать в нее учебный репозиторий по выданной ссылке (подсказка: **git clone**)
