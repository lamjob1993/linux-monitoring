...
### Последовательность выполнения заданий
  ...
  13. Открываем директорию **`postgresql`** → `README.md` → `tasks_1.md` → `tasks_2.md` → `tasks_3.md` → `tech_questions.md` → `job_interview.md` → **подумать над резервированием базы, сделать отдельный таск, поднять PostgreSQL Patroni**
  ...
  15. После исполнения всех пунктов выше (**добавить раздел, как считать количество и скорость метрик для каждой команды, снять метрики с Mimir и посчитать единицу измерения на рубль в отдельном дашборде**):
  ...
  17. Продолжаем изучение мониторинга в [следующем разделе](https://github.com/lamjob1993/docker-monitoring/tree/main) по **`Docker`**
  18. Продолжаем изучение мониторинга в [следующем разделе]() по **`Terraform`**
  19. Продолжаем изучение мониторинга в [следующем разделе]() по **`Ansible`**
  20. Продолжаем изучение мониторинга в [следующем разделе]() по **`CI/CD: Teamcity`**
  21. Продолжаем изучение мониторинга в [следующем разделе]() по **`Kubernetes`**
