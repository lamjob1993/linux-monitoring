...
### Последовательность выполнения заданий
  ...
  15. После исполнения всех пунктов выше (**добавить раздел, как считать количество и скорость метрик для каждой команды, снять метрики с Mimir и посчитать единицу измерения на рубль**):
