...
- Последовательность выполнения следующая:
  ...
  2. Открываем директорию Node Exporter, читаем файл readme и исполняем
  3. Открываем директорию Grafana, читаем файл readme и исполняем
  4. После исполнения настройте связку бэкенда мониторинга между собой
