...
- Последовательность выполнения следующая:
  1. Открываем директорию Prometheus и читаем файл readme
  2. Открываем директорию Node Exporter и читаем файл readme
  3. Открываем директорию Grafana и читаем файл readme 
