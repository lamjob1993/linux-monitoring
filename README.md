...
30. Далее перейти в первичную виртуальную машину **Ubuntu**, которая осталась рядом с клоном из **п.1** и запустить её рядом с вашим клоном **Ubuntu**.
