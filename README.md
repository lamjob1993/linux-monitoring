...
### Последовательность выполнения заданий
  ...
  13. Открываем директорию **`postgresql`** → `README.md` → `tasks_1.md` → `tasks_2.md` → `tasks_3.md` → `tech_questions.md` → `job_interview.md` → **подумать над резервированием базы, сделать отдельный таск**
