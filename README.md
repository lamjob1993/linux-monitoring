...
1. Изначально у вас должна быть установлена первичная виртуалка (А) **Ubuntu 22.04**:
   - После установки склонируйте её (виртуалка Б) и продолжайте работать виртуалке (А)
