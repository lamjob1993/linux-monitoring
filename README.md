## Добро пожаловать на практикум по сопровождению и мониторингу ПО

### [Содержание / Глобальная навигация](https://github.com/lamjob1993/linux-monitoring/blob/main/navigation/README.md)
...
- ВАЖНО! [Пример глобальной схемы актуального проекта](https://miro.com/app/board/uXjVIMhc1ds=/) бэкенда после прохождения финального репозитория - **Kubernetes**
