...
### Последовательность выполнения заданий следующая
  1. Зарегистрируйтесь и настройте доступ по `SSH` в `GitHub` [по инструкции](https://github.com/lamjob1993/linux-monitoring/blob/main/%D0%93%D0%B5%D0%BD%D0%B5%D1%80%D0%B0%D1%86%D0%B8%D1%8F%20SSH%20%D0%B4%D0%BB%D1%8F%20GitHub.md):
      - [Сделайте форк](https://github.com/lamjob1993/linux-monitoring/blob/main/%D0%A4%D0%BE%D1%80%D0%BA%20%D0%B2%20GitHub.md) текущего [репозитория](https://github.com/lamjob1993/linux-monitoring/tree/main)
  ...
  7. После исполнения полностью настройте бэкенд мониторинга и дашборды для всех экпортеров:
      - Натравите `Prometheus` на все экспортеры и замониторьте ваш сервер (ваша тачка) в `Grafana`
