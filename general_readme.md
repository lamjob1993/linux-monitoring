### Добро пожаловать в репозиторий под названием Linux. В этой части мы поднимем мониторинг: Grafana + Prometheus + Node Exporter и научимся настраивать эту связку.
