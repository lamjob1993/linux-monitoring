...
https://chat.qwen.ai/c/a1646855-d45a-40fb-b3be-325bce101788
...
## Шаг 4.2: Проверка таблиц в базе данных

```
\dt
```

## Шаг 4.3: Эта команда покажет список всех таблиц в текущей базе данных
