...
_Перед выполнением этого пункта для начала изучите [эту тему вместе с тасками](https://github.com/lamjob1993/linux-monitoring/tree/main/nginx) и возвращайтесь сюда на практику._
