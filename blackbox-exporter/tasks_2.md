...
_Перед выполнением этого раздела для начала изучите [эту тему](https://github.com/lamjob1993/linux-monitoring/tree/main/nginx) и возвращайтесь сюда на практику._
