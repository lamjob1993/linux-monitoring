...
# В Grafana Mimir отвечает за управление членством в кластере, обнаружение сбоев узлов и передачу сообщений между экземплярами с использованием протокола на основе "gossip"
memberlist:
