# Устная легенда инженера по сопровождению ПО, работающего в отделе мониторинга к собеседованию (в резюме ничего отсюда не берем)
...
- **Process Exporter**: Мониторинг процессорв на серверах (/proc).
...
- **Языки программирования (язык бэкенда):**
